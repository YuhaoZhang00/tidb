...
replace (
	...
	github.com/tikv/client-go/v2 => github.com/YuhaoZhang00/client-go/v2 v2.0.8-0.20260601032508-148af8cb0465
	github.com/tikv/pd/client => github.com/YuhaoZhang00/pd/client v0.0.0-20260607141534-adcf2e5a5584
